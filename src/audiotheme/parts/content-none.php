	...
	<div class="page-header">
		...
		<div class="page-content">
			...
			<?php if ( current_user_can( 'publish_posts' ) ) : ?>
				...
				<p>
					<?php
					printf( _x( 'Ready to publish your first %1$s? <a href="%2$s">Get started here</a>.', 'post type label; add post type link', 'progeny-mmxv' ),
			...
			<?php else : ?>
				...
				<p>
					<?php
					printf( _x( 'There are currently not any %s available.', 'post type label', 'progeny-mmxv' ),
