...
class Cedaro_Theme_Archive_Feature_Content extends Cedaro_Theme_Archive_Feature {
	...
	public function add_support( $options = array() ) {
		if ( empty( $options ) ) {
			$options = array(
				'full-text'       => esc_html__( 'Full Text', 'cedaro-theme' ),
				'summary'         => esc_html__( 'Summary', 'cedaro-theme' ),
				'custom-excerpts' => esc_html__( 'Custom Excerpts', 'cedaro-theme' ),
				'none'            => esc_html__( 'No Content', 'cedaro-theme' ),
			);
		}
	...
	public function customize_register( $wp_customize ) {
		...
		$wp_customize->add_control( 'cedaro_archive_content_mode', array(
			'label'    => esc_html__( 'Archive Content', 'cedaro-theme' ),
